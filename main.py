...
def create_menu_for_role(role: str = None) -> InlineKeyboardMarkup:
    ...
    if role is None:
        ...
        keyboard = [
            [InlineKeyboardButton("📋 Request for Meter Submeeting", callback_data="request_submeeting")],
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("📈 View Own Readings / Chart", callback_data="view_own_readings")],
            [InlineKeyboardButton("📋 Request for Meter Submeeting", callback_data="request_submeeting")],
            [InlineKeyboardButton("ℹ️ About Bot", callback_data="about_bot")],
        ]
        ...
        keyboard = [
            [InlineKeyboardButton("📊 Submit Reading", callback_data="submit_reading")],
            [InlineKeyboardButton("📥 Export Readings (CSV)", callback_data="export_readings")],
            [InlineKeyboardButton("📈 View Readings / Chart", callback_data="view_readings")],
            [InlineKeyboardButton("📋 Request for Meter Submeeting", callback_data="request_submeeting")],
            [InlineKeyboardButton("ℹ️ About Bot", callback_data="about_bot")],
        ]
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("👥 Assign / Revoke Roles", callback_data="manage_roles")],
            [InlineKeyboardButton("➕ Add / Deactivate Users", callback_data="manage_users")],
            [InlineKeyboardButton("🏠 Manage Apartment List", callback_data="manage_apartments")],
            [InlineKeyboardButton("ℹ️ About Bot", callback_data="about_bot")],
        ]
